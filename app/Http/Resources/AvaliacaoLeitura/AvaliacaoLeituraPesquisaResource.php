...
namespace App\Http\Resources\AvaliacaoLeitura;
...
class AvaliacaoLeituraPesquisaResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'data_inicio' => Carbon::parse($this->data_inicio)->format('d/m/Y H:i:s'),
            'data_termino' => Carbon::parse($this->data_termino)->format('d/m/Y H:i:s'),
